                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-4 mb-10">
                            <a href="#" className="inline-flex items-center px-5 py-3 rounded-xl bg-white text-[#1A2744] hover:bg-white/90 transition-colors cursor-pointer">
                            ...
                            <div className="flex gap-2 mb-6">
                                {quickActions.map((action) => (
                                    <button
                                        ...
                                        className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl font-semibold text-sm transition-all cursor-pointer ${activeTab === action.id
